...
<?php $this->load->view('templates/sidebar_client'); ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                ...
                                Lengkapi data formulir dengan benar untuk melanjutkan ke tahap berikutnya, data yang
                                berbintang (*) wajib diisi.
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                                <div class="tab-pane fade show active" id="bordered-justified-home" role="tabpanel"
                                    ...
                                    <form action="<?php echo base_url('client/formulir/update_data_siswa'); ?>"
                                        method="post">
                                        <h5 class="card-title mb-0 pb-0">Data Pribadi Siswa</h5>
                                        <hr>
                                        <?php $this->load->view('client/formulir/layout/form_data_siswa'); ?>
                                        <h5 class="card-title mb-0 pb-0">Data Orang Tua Siswa</h5>
                                        <hr>
                                        <?php $this->load->view('client/formulir/layout/form_data_ayah'); ?>
                                        <!-- <hr>
                                        <?php// $this->load->view('client/formulir/layout/form_data_ibu');?> -->
                                ...
                                <div class="tab-pane fade" id="bordered-justified-alamat" role="tabpanel"
                                    ...
                                    <form action="<?php echo base_url('client/formulir/update_alamat_siswa'); ?>"
                                        method="post">
                                        <h5 class="card-title mb-0 pb-0">Data Alamat Siswa</h5>
                                        <hr>
                                        <?php $this->load->view('client/formulir/layout/form_data_alamat'); ?>
                                        <div class="row d-flex justify-content-start mt-3">
                                            <div class="col-md-3">
                                                <button type="submit" class="btn btn-primary w-100">Simpan</button>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="bordered-justified-profile" role="tabpanel"
                                    ...
                                    <form action="<?php echo base_url('client/formulir/update_berkas_siswa'); ?>"
                                        method="post" enctype="multipart/form-data">
                                        <h5 class="card-title mb-0 pb-0">Data Berkas Siswa</h5>
                                        <hr>
                                        <?php $this->load->view('client/formulir/layout/form_data_berkas'); ?>
                                        <div class="row d-flex justify-content-start mt-3">
                                            <div class="col-md-3">
                                                <button type="submit" class="btn btn-primary w-100">Simpan</button>
                                            </div>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?php echo base_url('client/formulir/get_provinces');?>",
            type: "GET",
            dataType: "json",
        ...
        $('#provinsi').on('change', function() {
            ...
            if (id_provinsi) {
                $.ajax({
                    url: `<?php echo base_url('client/formulir/get_regencies');?>/${id_provinsi}`,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
        ...
        $('#kabupaten').on('change', function() {
            ...
            if (id_kabupaten) {
                $.ajax({
                    url: `<?php echo base_url('client/formulir/get_districts');?>/${id_kabupaten}`,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
        ...
        $('#kecamatan').on('change', function() {
            ...
            if (id_kecamatan) {
                $.ajax({
                    url: `<?php echo base_url('client/formulir/get_villages');?>/${id_kecamatan}`,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
