...
<body>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?=base_url('client/formulir/get_provinces');?>",
            type: "GET",
            dataType: "json",
        ...
        $('#provinsi').on('change', function() {
            ...
            if (id_provinsi) {
                $.ajax({
                    url: `<?=base_url('client/formulir/get_regencies');?>/${id_provinsi}`,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
        ...
        $('#kabupaten').on('change', function() {
            ...
            if (id_kabupaten) {
                $.ajax({
                    url: `<?=base_url('client/formulir/get_districts');?>/${id_kabupaten}`,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
        ...
        $('#kecamatan').on('change', function() {
            ...
            if (id_kecamatan) {
                $.ajax({
                    url: `<?=base_url('client/formulir/get_villages');?>/${id_kecamatan}`,
                    type: "GET",
                    dataType: "json",
                    success: function(response) {
